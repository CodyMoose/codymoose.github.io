...
class myPoint{
    ...
    steer(){
        ...
        // let steeringForceMag = 100 / pow(this.position.dist(this.target), 4);
        // let steeringForce = p5.Vector.sub(this.target, this.position);
        // steeringForce.setMag(steeringForceMag);
