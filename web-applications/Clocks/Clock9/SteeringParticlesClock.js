...
class myPoint{
    constructor(x, y, index){
        this.i = index;
        // this.position = createVector(x + this.velocity.x, y + this.velocity.y);
    ...
    steer(){
        let steeringForce = p5.Vector.mult(p5.Vector.sub(this.desired, this.velocity), 0.25);
